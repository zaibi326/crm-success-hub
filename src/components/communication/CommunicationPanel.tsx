    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Communication Center - SmrtPhone.io
        </CardTitle>
      </CardHeader>
      <CardContent>
        <Tabs defaultValue="call" className="w-full">
          ...
          <TabsContent value="call" className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
              <div>
                <p className="font-medium">{leadName || 'Contact'}</p>
          ...
          <TabsContent value="sms" className="space-y-4">
            <div className="space-y-4">
              <div>
                <label className="text-sm font-medium mb-2 block">Send SMS to {phoneNumber}</label>
                <Textarea
                ...
                <div key={record.id} className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {record.duration && (
                        <p className="text-sm text-gray-500">Duration: {record.duration}</p>
                      )}
                      {record.message && (
